...
class IMBALANCECIFAR100(torchvision.datasets.CIFAR100):
    cls_num = 100
    def __init__(self, root, quantity_ratio,imb_type='exp', imb_factor=0.01, rand_number=0, train=True,
...
class CIFAR100_LT(object):
    ...
    def __init__(self, root='./data/imbalance_cifar100',quantity_ratio=1.0, imb_type='exp',
        ...
        train_dataset = IMBALANCECIFAR100(root=root, quantity_ratio=quantity_ratio,imb_type=imb_type, imb_factor=imb_factor, rand_number=0, train=True,
