...
class iNaturalistDataLoader(DataLoader):
    ...
    def __init__(self, data_dir, batch_size, shuffle=True, num_workers=1, training=True, balanced=False, retain_epoch_size=True):
        ...
        if training:
            dataset = LT_Dataset(data_dir, './datasets/data_txt/iNaturalist18_train.txt', train_trsfm)
            val_dataset = LT_Dataset(data_dir, data_dir + './datasets/data_txt/iNaturalist18_val.txt', test_trsfm)
        else: # test
            dataset = LT_Dataset(data_dir, data_dir + './datasets/data_txt/iNaturalist18_val.txt', test_trsfm)
            val_dataset = None
