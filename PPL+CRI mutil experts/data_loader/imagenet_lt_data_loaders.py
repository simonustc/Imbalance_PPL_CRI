...
class ImageNetLTDataLoader(DataLoader):
    ...
    def __init__(self, data_dir, batch_size, shuffle=True, num_workers=1, training=True, balanced=False, retain_epoch_size=True):
        ...
        data_dir='/home/xmj/4T/work/cvpr_lt/classifier-balancing-master/classifier-balancing-master/data/data/ImageNet/'

        if training:
            dataset = LT_Dataset(data_dir, '/home/xmj/4T/work/cvpr_lt/MS-image4/datasets/data_txt/ImageNet_LT_train.txt',train_trsfm)
            val_dataset = LT_Dataset(data_dir, '/home/xmj/4T/work/cvpr_lt/MS-image4/datasets/data_txt/ImageNet_LT_test.txt', test_trsfm)
        else: # test
    ...
    def split_validation(self):
        ...
        return DataLoader(dataset=self.val_dataset, **self.init_kwargs1)
