...
class CIFAR100_LT(object):
    ...
    def __init__(self, root='./data/imbalance_cifar100',imb_ratio=1.0, imb_type='exp',
        ...
        train_dataset = IMBALANCECIFAR100(root=root, imb_ratio=imb_ratio,imb_type=imb_type, imb_factor=imb_factor, rand_number=0, train=True,
